...
onMounted(() => {
  ...
  formData.full_name = props.patient.full_name || ''
  formData.gender = props.patient.gender || ''
  formData.date_of_birth = props.patient.date_of_birth ? props.patient.date_of_birth.split('T')[0] : ''
  formData.phone = props.patient.phone || ''
  formData.address = props.patient.address || ''
})
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await adminAPI.updatePatient(authStore.token, props.patient.id, payload)

    toastMessage.value = 'Patient updated successfully!'
  ...
  <div class="modal-overlay" @click="handleCancel">
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-body">
        ...
        <p class="info-text">Only the following fields can be edited:</p>
